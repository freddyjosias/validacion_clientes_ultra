...
ALTER TABLE data_ultra_emision ADD desc_observacion VARCHAR(150) NOT NULL DEFAULT ''
ALTER TABLE data_ultra_emision ADD es_sva tinyint NOT NULL DEFAULT 0
ALTER TABLE data_ultra_emision ADD sva_cir_codigo int NOT NULL DEFAULT 0

ALTER TABLE data_ultra_procesado ADD flg_check_nom_v2 int NOT NULL DEFAULT 0
ALTER TABLE data_ultra_procesado ADD flg_nombre_validado int NOT NULL DEFAULT 0
...
SELECT desc_activacion_habil, desc_observacion_activacion, * FROM data_ultra_procesado p order by 1
SELECT cod_pedido_pf_ultra, * FROM data_ultra_procesado p order by 2

select * from data_ultra_procesado where nro_documento = '000320768'


---------------------------------------------------------------------------------

UPDATE data_ultra_procesado SET ape_paterno = 'PUYÓ' WHERE id_data = '2'; 
UPDATE data_ultra_procesado SET flg_check_nom_v2 = 1 WHERE id_data = 2;
UPDATE data_ultra_procesado SET nombres = 'JP SA COUTO PERU S.A.C.' WHERE id_data = '18'; 
UPDATE data_ultra_procesado SET flg_check_nom_v2 = 1 WHERE id_data = 18; 
UPDATE data_ultra_procesado SET ape_paterno = 'LEÓN' WHERE id_data = '26'; 
UPDATE data_ultra_procesado SET flg_check_nom_v2 = 1 WHERE id_data = 26; 
UPDATE data_ultra_procesado SET nombres = 'PRODUCCIONES FOTOGRAFICAS SOCIEDAD ANONIMA - PROFOT S.A.' WHERE id_data = '27'; 
UPDATE data_ultra_procesado SET flg_check_nom_v2 = 1 WHERE id_data = 27; 
UPDATE data_ultra_procesado SET ape_materno = 'DE LA PEÑA' WHERE id_data = '36'; 
UPDATE data_ultra_procesado SET flg_check_nom_v2 = 1 WHERE id_data = 36; 
UPDATE data_ultra_procesado SET ape_paterno = 'MUÑIZ' WHERE id_data = '38'; 
UPDATE data_ultra_procesado SET flg_check_nom_v2 = 1 WHERE id_data = 38; 
UPDATE data_ultra_procesado SET ape_materno = 'DEL SOLAR DE ONRUBIA' WHERE id_data = '45'; 
UPDATE data_ultra_procesado SET flg_check_nom_v2 = 1 WHERE id_data = 45; 
UPDATE data_ultra_procesado SET nombres = 'MCC FILMS SAC' WHERE id_data = '51'; 
UPDATE data_ultra_procesado SET flg_check_nom_v2 = 1 WHERE id_data = 51; 
UPDATE data_ultra_procesado SET nombres = 'THOMAS RUTHERFORD' WHERE id_data = '64'; 
UPDATE data_ultra_procesado SET ape_paterno = 'MOORE' WHERE id_data = '64'; 
UPDATE data_ultra_procesado SET ape_materno = 'HUYETT' WHERE id_data = '64'; 
UPDATE data_ultra_procesado SET nro_documento = '00320768' WHERE id_data = '64'; 
UPDATE data_ultra_procesado SET nombres = 'HERNAN LESTER' WHERE id_data = '71'; 
UPDATE data_ultra_procesado SET flg_check_nom_v2 = 1 WHERE id_data = 71; 
UPDATE data_ultra_procesado SET ape_paterno = 'REAÑO' WHERE id_data = '87'; 
UPDATE data_ultra_procesado SET flg_check_nom_v2 = 1 WHERE id_data = 87; 
UPDATE data_ultra_procesado SET nombres = 'CASTRO DE LA MATA SOCIEDAD CIVIL DE RESPONSABILIDAD LIMITADA' WHERE id_data = '91'; 
UPDATE data_ultra_procesado SET flg_check_nom_v2 = 1 WHERE id_data = 91; 
UPDATE data_ultra_procesado SET ape_paterno = 'AGÜERO' WHERE id_data = '129'; 
UPDATE data_ultra_procesado SET flg_check_nom_v2 = 1 WHERE id_data = 129; 
UPDATE data_ultra_procesado SET nombres = 'BACK OFFICE ALRO S.A.C' WHERE id_data = '135'; 
UPDATE data_ultra_procesado SET flg_check_nom_v2 = 1 WHERE id_data = 135;
UPDATE data_ultra_procesado SET nombres = 'DIANA' WHERE id_data = '137'; 
UPDATE data_ultra_procesado SET flg_check_nom_v2 = 1 WHERE id_data = 137; 
UPDATE data_ultra_procesado SET nombres = 'ARCH PARTNERS INVERSIONES INMOBILIARIAS E.I.R.L.' WHERE id_data = '143'; 
UPDATE data_ultra_procesado SET flg_check_nom_v2 = 1 WHERE id_data = 143; 
UPDATE data_ultra_procesado SET ape_materno = 'GONZALES' WHERE id_data = '154'; 
UPDATE data_ultra_procesado SET flg_check_nom_v2 = 1 WHERE id_data = 154; 
UPDATE data_ultra_procesado SET nombres = '4D2 STUDIOS' WHERE id_data = '156'; 
UPDATE data_ultra_procesado SET flg_check_nom_v2 = 1 WHERE id_data = 156; 
UPDATE data_ultra_procesado SET nombres = 'JUAN JOSÉ' WHERE id_data = '158'; 
UPDATE data_ultra_procesado SET flg_check_nom_v2 = 1 WHERE id_data = 158; 
UPDATE data_ultra_procesado SET ape_materno = 'RODRIGUEZ DE POBLETE' WHERE id_data = '163'; 
UPDATE data_ultra_procesado SET flg_check_nom_v2 = 1 WHERE id_data = 163; 
UPDATE data_ultra_procesado SET nombres = 'MARIA JOSEFINA CARMEN' WHERE id_data = '164'; 
UPDATE data_ultra_procesado SET ape_paterno = 'ARGUEDAS' WHERE id_data = '164'; 
UPDATE data_ultra_procesado SET ape_materno = 'MATUTE DE MARTELES' WHERE id_data = '164'; 
UPDATE data_ultra_procesado SET flg_check_nom_v2 = 1 WHERE id_data = 164; 
UPDATE data_ultra_procesado SET nombres = 'MARÍA ESTHER' WHERE id_data = '165'; 
UPDATE data_ultra_procesado SET flg_check_nom_v2 = 1 WHERE id_data = 165; 
UPDATE data_ultra_procesado SET ape_paterno = 'HARRINSON' WHERE id_data = '168'; 
UPDATE data_ultra_procesado SET flg_check_nom_v2 = 1 WHERE id_data = 168; 
UPDATE data_ultra_procesado SET ape_paterno = 'AÑAÑOS' WHERE id_data = '169'; 
UPDATE data_ultra_procesado SET flg_check_nom_v2 = 1 WHERE id_data = 169; 
UPDATE data_ultra_procesado SET nombres = 'INMOBILIARIA ALDABAS SAC' WHERE id_data = '170'; 
UPDATE data_ultra_procesado SET flg_check_nom_v2 = 1 WHERE id_data = 170; 
UPDATE data_ultra_procesado SET ape_materno = 'GALDÓS' WHERE id_data = '172'; 
UPDATE data_ultra_procesado SET flg_check_nom_v2 = 1 WHERE id_data = 172; 
UPDATE data_ultra_procesado SET ape_paterno = 'COVEÑAS' WHERE id_data = '175'; 
UPDATE data_ultra_procesado SET flg_check_nom_v2 = 1 WHERE id_data = 175; 
UPDATE data_ultra_procesado SET ape_materno = 'HERNÁNDEZ' WHERE id_data = '191'; 
UPDATE data_ultra_procesado SET flg_check_nom_v2 = 1 WHERE id_data = 191; 
UPDATE data_ultra_procesado SET nombres = 'COMPAÑIA DE JESUS COMUNIDAD DE FATIMA' WHERE id_data = '206'; 
UPDATE data_ultra_procesado SET flg_check_nom_v2 = 1 WHERE id_data = 206; 
UPDATE data_ultra_procesado SET ape_materno = 'VACCARI VDA DE MUSIRIS' WHERE id_data = '219'; 
UPDATE data_ultra_procesado SET flg_check_nom_v2 = 1 WHERE id_data = 219; 
UPDATE data_ultra_procesado SET nombres = 'ENRIQUE- ZICROM GROUP INTERNATIONAL' WHERE id_data = '221'; 
UPDATE data_ultra_procesado SET flg_check_nom_v2 = 1 WHERE id_data = 221; 
UPDATE data_ultra_procesado SET nombres = 'STEWART FREIRE & ASOCIADOS S.A.C. CORREDORES DE SEGUROS' WHERE id_data = '235'; 
UPDATE data_ultra_procesado SET flg_check_nom_v2 = 1 WHERE id_data = 235; 
UPDATE data_ultra_procesado SET nombres = 'INVESTMENT & HEALTH SERVICES S.A.C' WHERE id_data = '236'; 
UPDATE data_ultra_procesado SET flg_check_nom_v2 = 1 WHERE id_data = 236; 
UPDATE data_ultra_procesado SET nombres = 'FANG CONSTRUCTORES S.A.C' WHERE id_data = '237'; 
UPDATE data_ultra_procesado SET flg_check_nom_v2 = 1 WHERE id_data = 237; 
UPDATE data_ultra_procesado SET ape_materno = 'LÓPEZ-ALFARO DE ROMERO' WHERE id_data = '250'; 
UPDATE data_ultra_procesado SET flg_check_nom_v2 = 1 WHERE id_data = 250; 
UPDATE data_ultra_procesado SET nombres = 'MARGARITA E.' WHERE id_data = '269'; 
UPDATE data_ultra_procesado SET ape_materno = 'SILVERA DE GUIZADO' WHERE id_data = '269'; 
UPDATE data_ultra_procesado SET flg_check_nom_v2 = 1 WHERE id_data = 269; 
UPDATE data_ultra_procesado SET ape_paterno = 'MUÑOZ' WHERE id_data = '284'; 
UPDATE data_ultra_procesado SET flg_check_nom_v2 = 1 WHERE id_data = 284; 
UPDATE data_ultra_procesado SET nombres = 'MARIA' WHERE id_data = '296'; 
UPDATE data_ultra_procesado SET flg_check_nom_v2 = 1 WHERE id_data = 296; 
UPDATE data_ultra_procesado SET ape_materno = 'HAMEAU DE RUIZ DE SOMOCURCIO' WHERE id_data = '304'; 
UPDATE data_ultra_procesado SET flg_check_nom_v2 = 1 WHERE id_data = 304; 
UPDATE data_ultra_procesado SET nombres = 'MAS COMUNICADORES SOCIEDAD ANONIMA CERRADA' WHERE id_data = '327'; 
UPDATE data_ultra_procesado SET flg_check_nom_v2 = 1 WHERE id_data = 327; 
UPDATE data_ultra_procesado SET nombres = 'NICOLAS ENRIQUE' WHERE id_data = '336'; 
UPDATE data_ultra_procesado SET ape_materno = '.' WHERE id_data = '336'; 
UPDATE data_ultra_procesado SET flg_check_nom_v2 = 1 WHERE id_data = 336; 
UPDATE data_ultra_procesado SET ape_paterno = 'FARIAS' WHERE id_data = '354'; 
UPDATE data_ultra_procesado SET flg_check_nom_v2 = 1 WHERE id_data = 354; 
UPDATE data_ultra_procesado SET ape_paterno = 'GOÑI' WHERE id_data = '362'; 
UPDATE data_ultra_procesado SET flg_check_nom_v2 = 1 WHERE id_data = 362; 
UPDATE data_ultra_procesado SET nombres = 'ALFREDO' WHERE id_data = '398';
UPDATE data_ultra_procesado SET flg_check_nom_v2 = 1 WHERE id_data = 398; 
UPDATE data_ultra_procesado SET nombres = 'NUMA AMERICAS CORP' WHERE id_data = '408'; 
UPDATE data_ultra_procesado SET ape_paterno = '.' WHERE id_data = '408'; 
UPDATE data_ultra_procesado SET ape_materno = '.' WHERE id_data = '408'; 
UPDATE data_ultra_procesado SET flg_check_nom_v2 = 1 WHERE id_data = 408; 
UPDATE data_ultra_procesado SET ape_paterno = 'PEÑA' WHERE id_data = '410'; 
UPDATE data_ultra_procesado SET flg_check_nom_v2 = 1 WHERE id_data = 410; 
UPDATE data_ultra_procesado SET ape_materno = 'CHACÓN' WHERE id_data = '414'; 
UPDATE data_ultra_procesado SET flg_check_nom_v2 = 1 WHERE id_data = 414; 
UPDATE data_ultra_procesado SET nombres = 'GERMAN HORACIO' WHERE id_data = '427'; 
UPDATE data_ultra_procesado SET ape_materno = '.' WHERE id_data = '427'; 
UPDATE data_ultra_procesado SET flg_check_nom_v2 = 1 WHERE id_data = 427; 
UPDATE data_ultra_procesado SET nombres = 'BETTINA' WHERE id_data = '439'; 
UPDATE data_ultra_procesado SET flg_check_nom_v2 = 1 WHERE id_data = 439; 
UPDATE data_ultra_procesado SET ape_materno = 'NEYRA' WHERE id_data = '444'; 
UPDATE data_ultra_procesado SET flg_check_nom_v2 = 1 WHERE id_data = 444; 
UPDATE data_ultra_procesado SET ape_materno = 'FLOREZ - ESTRADA' WHERE id_data = '452'; 
UPDATE data_ultra_procesado SET flg_check_nom_v2 = 1 WHERE id_data = 452; 
UPDATE data_ultra_procesado SET nombres = 'JOSÉ FERNANDO' WHERE id_data = '458'; 
UPDATE data_ultra_procesado SET flg_check_nom_v2 = 1 WHERE id_data = 458; 
UPDATE data_ultra_procesado SET nombres = 'JOSÉ ALONSO' WHERE id_data = '479'; 
UPDATE data_ultra_procesado SET flg_check_nom_v2 = 1 WHERE id_data = 479;
UPDATE data_ultra_procesado SET ape_paterno = 'NUÑEZ' WHERE id_data = '497'; 
UPDATE data_ultra_procesado SET flg_check_nom_v2 = 1 WHERE id_data = 497; 
UPDATE data_ultra_procesado SET nombres = 'E-LEMENTAL PERU S.A.C.' WHERE id_data = '505'; 
UPDATE data_ultra_procesado SET flg_check_nom_v2 = 1 WHERE id_data = 505; 
UPDATE data_ultra_procesado SET nombres = 'ARMANDO RODOLFO MIGUEL' WHERE id_data = '507'; 
UPDATE data_ultra_procesado SET nombres = 'HARDCOMP S.R.L.' WHERE id_data = '510'; 
UPDATE data_ultra_procesado SET flg_check_nom_v2 = 1 WHERE id_data = 510; 
UPDATE data_ultra_procesado SET ape_materno = 'DAHUPD' WHERE id_data = '512';
UPDATE data_ultra_procesado SET flg_check_nom_v2 = 1 WHERE id_data = 512; 
UPDATE data_ultra_procesado SET nombres = 'TAMESIS ADVISORS S.A.C.' WHERE id_data = '515'; 
UPDATE data_ultra_procesado SET flg_check_nom_v2 = 1 WHERE id_data = 515; 
UPDATE data_ultra_procesado SET ape_paterno = 'LUNA' WHERE id_data = '521'; 
UPDATE data_ultra_procesado SET ape_materno = 'REQUENA DE SIGARROSTEGUI' WHERE id_data = '521'; 
UPDATE data_ultra_procesado SET flg_check_nom_v2 = 1 WHERE id_data = 521; 
UPDATE data_ultra_procesado SET nombres = 'FARM2MARKET SOCIEDAD ANONIMA CERRADA - F2M S.A.C.' WHERE id_data = '522'; 
UPDATE data_ultra_procesado SET flg_check_nom_v2 = 1 WHERE id_data = 522; 
UPDATE data_ultra_procesado SET ape_materno = '.' WHERE id_data = '524'; 
UPDATE data_ultra_procesado SET flg_check_nom_v2 = 1 WHERE id_data = 524; 
UPDATE data_ultra_procesado SET ape_materno = 'FLOREZ-ESTRADA' WHERE id_data = '526'; 
UPDATE data_ultra_procesado SET flg_check_nom_v2 = 1 WHERE id_data = 526; 
UPDATE data_ultra_procesado SET ape_paterno = 'SANCHEZ - MANRIQUE' WHERE id_data = '528'; 
UPDATE data_ultra_procesado SET flg_check_nom_v2 = 1 WHERE id_data = 528; 
UPDATE data_ultra_procesado SET nombres = 'DIEGO' WHERE id_data = '531'; 
UPDATE data_ultra_procesado SET flg_check_nom_v2 = 1 WHERE id_data = 531; 
UPDATE data_ultra_procesado SET nombres = 'ROD & REN SOCIEDAD ANONIMA CERRADA - ROD & REN SAC' WHERE id_data = '532'; 
UPDATE data_ultra_procesado SET flg_check_nom_v2 = 1 WHERE id_data = 532; 
UPDATE data_ultra_procesado SET nombres = 'MARCO ANTONIO' WHERE id_data = '533'; 
UPDATE data_ultra_procesado SET flg_check_nom_v2 = 1 WHERE id_data = 533; 
UPDATE data_ultra_procesado SET nombres = 'FRANCESCA' WHERE id_data = '539'; 
UPDATE data_ultra_procesado SET ape_materno = 'BONAZZI' WHERE id_data = '539'; 
UPDATE data_ultra_procesado SET flg_check_nom_v2 = 1 WHERE id_data = 539; 
UPDATE data_ultra_procesado SET nombres = 'CARMEN ROSA' WHERE id_data = '545'; 
UPDATE data_ultra_procesado SET flg_check_nom_v2 = 1 WHERE id_data = 545; 
UPDATE data_ultra_procesado SET ape_materno = '.' WHERE id_data = '548'; 
UPDATE data_ultra_procesado SET flg_check_nom_v2 = 1 WHERE id_data = 548; 
UPDATE data_ultra_procesado SET ape_paterno = 'MUÑOZ NAJAR' WHERE id_data = '551'; 
UPDATE data_ultra_procesado SET flg_check_nom_v2 = 1 WHERE id_data = 551; 
UPDATE data_ultra_procesado SET ape_materno = 'RUIZ-ELDREDGE' WHERE id_data = '554'; 
UPDATE data_ultra_procesado SET flg_check_nom_v2 = 1 WHERE id_data = 554; 
UPDATE data_ultra_procesado SET nombres = 'JRLG CONSULTORIA Y CONSTRUCCION SAC' WHERE id_data = '557'; 
UPDATE data_ultra_procesado SET flg_check_nom_v2 = 1 WHERE id_data = 557; 
UPDATE data_ultra_procesado SET ape_materno = '.' WHERE id_data = '565'; 
UPDATE data_ultra_procesado SET flg_check_nom_v2 = 1 WHERE id_data = 565; 
UPDATE data_ultra_procesado SET ape_paterno = 'GONZÁLEZ' WHERE id_data = '573'; 
UPDATE data_ultra_procesado SET ape_materno = 'RÍOS' WHERE id_data = '573'; 
UPDATE data_ultra_procesado SET flg_check_nom_v2 = 1 WHERE id_data = 573; 
UPDATE data_ultra_procesado SET flg_check_nom_v2 = 1 WHERE id_data = 579; 
UPDATE data_ultra_procesado SET flg_check_nom_v2 = 1 WHERE id_data = 579; 
UPDATE data_ultra_procesado SET nro_documento = 'AG774859' WHERE id_data = '582'; 
UPDATE data_ultra_procesado SET nro_documento = '20190065' WHERE id_data = '584';
UPDATE data_ultra_procesado SET nro_documento = '01655107' WHERE id_data = '585'; 
UPDATE data_ultra_procesado SET flg_check_nom_v2 = 1 WHERE id_data = 587; 
UPDATE data_ultra_procesado SET nro_documento = '945609' WHERE id_data = '591'; 
UPDATE data_ultra_procesado SET nro_documento = 'A9155857' WHERE id_data = '594'; 
UPDATE data_ultra_procesado SET nro_documento = 'AUN B49521' WHERE id_data = '596'; 
UPDATE data_ultra_procesado SET flg_check_nom_v2 = 1 WHERE id_data = 597; 
UPDATE data_ultra_procesado SET nro_documento = '00000733531' WHERE id_data = '598'; 
UPDATE data_ultra_procesado SET nro_documento = '00000574646' WHERE id_data = '599'; 
UPDATE data_ultra_procesado SET ape_materno = 'LOREÑA' WHERE id_data = '603'; 
UPDATE data_ultra_procesado SET flg_check_nom_v2 = 1 WHERE id_data = 603; 
UPDATE data_ultra_procesado SET nombres = 'COGNITTIVA PSICOLOGIA INTEGRAL S.A.C.' WHERE id_data = '606'; 
UPDATE data_ultra_procesado SET flg_check_nom_v2 = 1 WHERE id_data = 606; 
UPDATE data_ultra_procesado SET ape_paterno = 'DE VIVERO' WHERE id_data = '610';
UPDATE data_ultra_procesado SET nombres = 'ADRIAN GABRIEL LUIS FABIANO BEJAR' WHERE id_data = '610';
UPDATE data_ultra_procesado SET flg_check_nom_v2 = 1 WHERE id_data = 610; 
UPDATE data_ultra_procesado SET nombres = 'CHUQUIHUANCA GARCIA SOCIEDAD CIVIL DE RESPONSABILI' WHERE id_data = '625'; 
UPDATE data_ultra_procesado SET flg_check_nom_v2 = 1 WHERE id_data = 625; 
UPDATE data_ultra_procesado SET ape_paterno = 'FERNANDEZ' WHERE id_data = '636'; 
UPDATE data_ultra_procesado SET flg_check_nom_v2 = 1 WHERE id_data = 636; 
UPDATE data_ultra_procesado SET ape_paterno = 'DE ROMAÑA' WHERE id_data = '683'; 
UPDATE data_ultra_procesado SET flg_check_nom_v2 = 1 WHERE id_data = 683; 
UPDATE data_ultra_procesado SET ape_paterno = 'MUNHOZ' WHERE id_data = '692'; 
UPDATE data_ultra_procesado SET flg_check_nom_v2 = 1 WHERE id_data = 692; 
UPDATE data_ultra_procesado SET nombres = 'TALIA MARIA DEL ROSARIO MARTINA' WHERE id_data = '697'; 
UPDATE data_ultra_procesado SET flg_check_nom_v2 = 1 WHERE id_data = 697; 
UPDATE data_ultra_procesado SET nombres = 'JAVIER ANDRÉS' WHERE id_data = '701'; 
UPDATE data_ultra_procesado SET flg_check_nom_v2 = 1 WHERE id_data = 701; 
UPDATE data_ultra_procesado SET nombres = 'ALMACENES FRIO NARVAL S.A.C - ALMACENES NARVAL S.A.C' WHERE id_data = '722'; 
UPDATE data_ultra_procesado SET flg_check_nom_v2 = 1 WHERE id_data = 722; 
UPDATE data_ultra_procesado SET ape_materno = 'ROMERO' WHERE id_data = '725'; 
UPDATE data_ultra_procesado SET flg_check_nom_v2 = 1 WHERE id_data = 725; 

--------------------------------------------------------------------------------

UPDATE data_ultra_procesado SET ape_materno = 'DE LA PEÑA' WHERE id_data = '70'; 
UPDATE data_ultra_procesado SET ape_materno = 'DEL SOLAR DE ONRUBIA' WHERE id_data = '77'; 
UPDATE data_ultra_procesado SET nro_documento = '00353411' WHERE id_data = '579'; 
UPDATE data_ultra_procesado SET flg_check_nom_v2 = 1 WHERE id_data = '585'; 
UPDATE data_ultra_procesado SET nro_documento = '20211001' WHERE id_data = '587'; 
UPDATE data_ultra_procesado SET flg_check_nom_v2 = 1 WHERE id_data = '587'; 
UPDATE data_ultra_procesado SET nro_documento = '00001262357' WHERE id_data = '597'; 
UPDATE data_ultra_procesado SET ape_paterno = 'AÑAÑOS' WHERE id_data = '689'; 

select * from data_ultra_procesado where nro_documento like '%1262357'
...
INNER JOIN data_ultra_procesado_bk2 d on p.id_data = d.id_data
...
SELECT * FROM data_ultra_procesado WHERE cod_circuito = 31151

UPDATE data_ultra_proc_detalle_pr SET desc_concepto = 'Ultra 600' where desc_concepto in ('Servicio de Internet Ultra')
and cod_circuito in (select cod_circuito from data_ultra_procesado where desc_oferta = 'Migración Ultra 600 - MPLS');



select * from data_ultra_proc_detalle_pr where desc_concepto in ('Servicio de Internet Ultra')
and cod_circuito in (select cod_circuito from data_ultra_procesado where desc_oferta = 'Migración Ultra 1000 - MPLS');

select cod_circuito from data_ultra_procesado where desc_oferta = 'Migración Ultra 800 - MPLS'
select cod_circuito from data_ultra_procesado where desc_oferta = 'Migración Ultra 600 - MPLS'
...
inner join data_ultra_procesado d on p.cod_circuito = d.cod_circuito and p.cod_pedido_ultra = d.cod_pedido_ultra
...
select * from data_ultra_procesado where cod_circuito = 216723
...
select * from data_ultra_procesado where cod_circuito in (
...
-- truncate table data_ultra_proc_detalle_pr
	...
	FROM data_ultra_procesado order by id_data
...
select * into data_ultra_procesado_bk4 from data_ultra_procesado

ALTER TABLE data_ultra_procesado ADD desc_ubigeo varchar(10) NOT NULL DEFAULT ''

UPDATE data_ultra_procesado SET desc_direccion = ''
...
SELECT desc_direccion, cod_circuito, cod_pedido_ultra FROM data_ultra_procesado
...
select * from data_ultra_procesado where nro_documento = '20604806152'
...
-- UPDATE data_ultra_procesado SET desc_activacion_habil = '', desc_observacion_activacion = '';
...
SELECT * FROM data_ultra_procesado where nro_documento like '%08800237%'
SELECT * FROM data_ultra_raw
...
SELECT * FROM data_ultra_procesado order by id_data
SELECT * FROM data_ultra_procesado WHERE nro_documento = '000733531'
SELECT * FROM data_ultra_procesado WHERE status_ingreso_venta NOT in (10) order by id_data
SELECT * FROM data_ultra_procesado WHERE status_ingreso_venta in (1) order by nro_documento
 
SELECT id_data, nro_documento, status_ingreso_venta, status_resultado, * FROM data_ultra_procesado p WHERE status_ingreso_venta in (10) order by p.nro_documento
SELECT id_data, nro_documento, status_ingreso_venta, status_resultado, * FROM data_ultra_procesado p where p.status_ingreso_venta not in ('10', 1)  order by p.updated_at

select * from data_ultra_procesado where 
...
* FROM data_ultra_procesado WHERE nro_documento = '20603206925'

update data_ultra_procesado set flg_check_nombres = 1, status_ingreso_venta = 1 where status_resultado = 'Error en los nombres' and status_ingreso_venta = 23


UPDATE data_ultra_procesado SET desc_latitud = '-12.151686044989946', desc_longitud = '-77.0228522552664' where id_data = 284


update data_ultra_procesado set status_ingreso_venta = 1 where nro_documento = '20603206925'
...
desc_correo, desc_celular, desc_celular2 FROM data_ultra_procesado p 

SELECT id_data, nro_documento, status_ingreso_venta, status_resultado, * FROM data_ultra_procesado p order by p.nro_documento

SELECT * FROM data_ultra_procesado where nro_documento = '000025316'
SELECT * FROM data_ultra_procesado where status_ingreso_venta = 10 and status_resultado = 'ok'
-- where status_ingreso_venta = 10 and status_resultado = 'ok'

SELECT id_data, nro_documento, status_ingreso_venta, status_resultado,
* FROM data_ultra_procesado where status_ingreso_venta <> 1

UPDATE data_ultra_procesado SET status_ingreso_venta = 1, status_resultado = '' where nro_documento = '' and id_data = 0;
...
select * from data_ultra_procesado where desc_activacion_habil = 'HABILITADO' and desc_observacion_activacion <> 'El comprobante del 12/2024 no esta cobrado'

select * from data_ultra_procesado where cod_pedido_ultra <> 0 and desc_activacion_habil = 'HABILITADO'

select top 1 * from data_ultra_procesado order by nro_documento
...
select *
from data_ultra_emision_202412 d
left join data_ultra_procesado p on d.cli_nro_doc = p.nro_documento
...
-- update data_ultra_procesado set nro_documento = '000320768', tipo_documento = 'CE' where nro_documento = '00320768'
