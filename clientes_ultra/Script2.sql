...
INNER JOIN [10.1.4.20].PE_OPTICAL_ADM_PROD_20250103_103852.ECOM.ECOM_CONTRATO CO ON D.DOCI_COD_ECOM = CO.CONI_ID_CONTRATO
INNER JOIN [10.1.4.20].PE_OPTICAL_ADM_PROD_20250103_103852.ECOM.ECOM_EMPRESA_CLIENTE EC ON  CO.EMCI_ID_EMP_CLI = EC.EMCI_ID_EMP_CLI
INNER JOIN [10.1.4.20].PE_OPTICAL_ADM_PROD_20250103_103852.ECOM.ECOM_CLIENTE CLI ON EC.CLII_ID_CLIENTE = CLI.CLII_ID_CLIENTE AND P.PEDV_NUM_DOCUMENTO = CLI.CLIV_NRO_RUC -- AND CLI.CLII_ID_CLIENTE = C.CLII_COD_ECOM
INNER JOIN [10.1.4.20].PE_OPTICAL_ADM_PROD_20250103_103852.ECOM.ECOM_SERVICIO S ON CO.CONI_ID_CONTRATO = S.CONI_ID_CONTRATO
LEFT JOIN (
	SELECT CSQ.COMC_COD_ENTIDAD, CDSQ.SERI_ID_SERVICIO, MAX(CSQ.COMV_PERIODO_COMPROBANTE) PERIODO
    FROM [10.1.4.20].PE_OPTICAL_ADM_PROD_20250103_103852.ECOM.COMPROBANTE CSQ
    INNER JOIN [10.1.4.20].PE_OPTICAL_ADM_PROD_20250103_103852.ECOM.COMPROBANTE_DET CDSQ ON CSQ.COMC_COD_COMPROBANTE = CDSQ.COMC_COD_COMPROBANTE
...
INNER JOIN [10.1.4.20].PE_OPTICAL_ADM_PROD_20250103_103852.ECOM.ECOM_CONTRATO CO ON D.DOCI_COD_ECOM = CO.CONI_ID_CONTRATO
INNER JOIN [10.1.4.20].PE_OPTICAL_ADM_PROD_20250103_103852.ECOM.ECOM_EMPRESA_CLIENTE EC ON  CO.EMCI_ID_EMP_CLI = EC.EMCI_ID_EMP_CLI
INNER JOIN [10.1.4.20].PE_OPTICAL_ADM_PROD_20250103_103852.ECOM.ECOM_CLIENTE CLI ON EC.CLII_ID_CLIENTE = CLI.CLII_ID_CLIENTE AND P.PEDV_NUM_DOCUMENTO = CLI.CLIV_NRO_RUC
INNER JOIN [10.1.4.20].PE_OPTICAL_ADM_PROD_20250103_103852.ECOM.ECOM_SERVICIO S ON CO.CONI_ID_CONTRATO = S.CONI_ID_CONTRATO
WHERE P.PEDI_COD_PEDIDO IN ( 5007073, 5006988, 5006827, 5006817, 5006575, 5006059, 5006022, 5005630, 5005538, 5005416, 5005389, 5005374, 5004997, 5004946, 5004627, 
5004405, 5004326, 5004269, 5004106, 5004057, 5003868, 5003486, 5003069, 5002931, 5002824, 5002698, 5002641, 5002549, 5002385, 5002314, 5002024, 5001998, 5001896, 
5001844, 5001830, 5001761, 5001721, 5001573, 5001452, 5001444, 5001417, 5001413, 5001369, 5001300, 5001209, 5001059, 5001018, 5000859, 5000730, 5000567, 5000555, 
...
SELECT * FROM [10.1.4.20].[PE_OPTICAL_ADM_PROD_20250103_103852].ECOM.ECOM_CLIENTE WHERE CLII_ID_CLIENTE = 961241 AND CLIV_NRO_RUC = '20538849970'

SELECT * FROM [10.1.4.20].[PE_OPTICAL_ADM_PROD_20250103_103852].ECOM.ECOM_EMPRESA_CLIENTE WHERE EMCI_ID_EMP_CLI = 961241 
