...
WHERE CP.SERI_ID_SERVICIO = 67233 AND CPGV_PERIODO_CONSUMO > '202406'
ORDER BY CP.CPGV_PERIODO_CONSUMO, CP.SDEI_ID_SERVICIO_DETALLE;

SELECT *
FROM ECOM.ECOM_CONTROL_PAGO
WHERE SERI_ID_SERVICIO = 1940881 -- AND SDEI_ID_SERVICIO_DETALLE = 10300050
